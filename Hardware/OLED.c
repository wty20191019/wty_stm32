...
////#define  OLED_I2C_Start(x)       MyI2C_Start(x)
////#define  OLED_I2C_Stop(x)        MyI2C_Stop(x) 
////#define  OLED_I2C_SendByte(x)    MyI2C_SendByte(x)
////#define  OLED_I2C_Init(x)        MyI2C_Init(x)
...
//弃用 MyI2C  弃用 PB8 PB9
//    OLED_I2C_Start();                                               1
//    OLED_I2C_SendByte(OLED_ADDRESS);        //从机地址              2
//    MyI2C_ReceiveAck();                                             =
...
//    OLED_I2C_Stop();
    ...
    I2C_Send7bitAddress(I2C2, OLED_ADDRESS, I2C_Direction_Transmitter);     //硬件I2C发送从机地址，方向为发送
...
//    OLED_I2C_Init();           //弃用 MyI2C  弃用 PB8 PB9  //端口初始化  
