...
//#define     MPU6050_IIC_delay_4us()            DWT_Delay_us(4)
...
////void      MPU6050_IIC_Send_Byte(uint8_t txd);                     //MPU6050_IIC发送一个字节
////uint8_t   MPU6050_IIC_Read_Byte(uint8_t ack);           //MPU6050_IIC读取一个字节

//uint8_t   MPU6050_IIC_Read_Ack(uint32_t I2C_EVENT);                           //MPU6050_IIC等待ACK信号
////void MPU6050_IIC_Send_Ack(uint8_t ack);                           //MPU6050_IIC发送ACK信号
